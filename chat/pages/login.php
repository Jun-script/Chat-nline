			...
			<div class="login-content">
				<form method="POST" name="login_form">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control form-control-lg fs-15px" name="email" value="" placeholder="username@address.com">
					</div>
					<div class="mb-3">
						<div class="d-flex">
						...
						<input type="password" class="form-control form-control-lg fs-15px" name="password" value="" placeholder="Enter your password">
					</div>
					<div class="mb-3">
